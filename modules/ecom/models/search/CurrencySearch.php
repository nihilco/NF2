...
/**
 * CurrencySearch represents the model behind the search form about `app\modules\ecom\models\Currency`.
 */
class CurrencySearch extends Currency
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['symbol', 'abbr', 'name', 'description', 'date_created', 'timestamp'], 'safe'],
        ];
    }
